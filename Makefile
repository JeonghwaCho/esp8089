...
EXTRA_CFLAGS += -DDEBUG -DSIP_DEBUG -DFAST_TX_STATUS -DKERNEL_IV_WAR -DRX_SENDUP_SYNC -DHAS_FW -DTEST_MODE -DESP_CLASS
EXTRA_CFLAGS += -DHAS_INIT_DATA
# EXTRA_CFLAGS += -DINIT_DATA_CONF
...
OBJS = esp_init.o esp_debug.o sdio_sif_esp.o spi_sif_esp.o esp_io.o \
